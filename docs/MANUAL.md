...
| **Previous session Log file** | Used only by **Run previous session report**: path to a saved `.log` file (Browse opens `%LocalAppData%\NINA\Logs`). Persisted in settings. |
