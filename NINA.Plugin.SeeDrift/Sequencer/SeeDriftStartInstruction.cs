...
namespace NINA.Plugin.SeeDrift.Sequencer {
    ...
    [ExportMetadata("Description", "Arms SeeDrift drift tracking — frame recording begins with the next saved LIGHT image. Place before the imaging loop for each target.")]
