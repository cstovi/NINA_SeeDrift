...
[assembly: AssemblyDescription("Plate-solves LIGHT frames referenced by NINA session logs and writes versioned drift HTML to a report library with recent-log selection, dither, center, gap, and before/after analytics.")]
