...
[assembly: AssemblyMetadata("LongDescription", @"SeeDrift finds LIGHT FITS under your NINA image file path (recursive scan that skips calibration/reject-style subfolders), filtered by the UTC arm window between SeeDrift Start and Stop (or a Test window in plugin options). Each frame is plate-solved using your NINA plate-solve profile; drift is shown as ΔRA/ΔDec arcseconds vs the first solved frame.
