...
[assembly: AssemblyMetadata("LongDescription", @"SeeDrift finds LIGHT FITS under your NINA image file path using the same LIGHT folder layout as your Imaging file pattern in the active profile, filtered by the UTC arm window between SeeDrift Start and Stop (or a Test window in plugin options). Each frame is plate-solved using your NINA plate-solve profile; drift is shown as ΔRA/ΔDec arcseconds vs the first solved frame.
