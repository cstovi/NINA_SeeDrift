...
[assembly: AssemblyDescription("Plate-solves LIGHT frames referenced by NINA session logs and writes versioned drift HTML with dither, center, gap, and before/after analytics.")]
[assembly: AssemblyMetadata("ShortDescription", "Versioned drift HTML with whole-report before/after analytics.")]
...
When log lines correlate between exposures, dither and center-after-drift triggers appear in the HTML report with advisory effectiveness metrics and settings hints. Possible missing/unsolved frame gaps are marked, suspect tracking jumps are excluded from dither scoring, and schema-compatible saved reports can be compared by whole-report averages.")]
